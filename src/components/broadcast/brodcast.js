...
import broadcasting from "../../assets/broadcasting.png";
                ...
                <div className={"broadcast_sub_container pt-5"}>
                    ...
                    <div className={"dropdown-center pb-3"}>
                        ...
                        <div className={"d-grid gap-2 d-md-block broadcast-send"}>
                            <button className={"btn btn-primary broadcast-send-btn"} type={"button"} data-bs-toggle="modal" data-bs-target="#exampleModal"
                    ...
                    <div className={"modal-content"}>
                        <div className={"modal-header"}>
                            ...
                            <button type="button" className={"btn-close"} onClick={() => {
                                setValue(mapObject(values, function(val, key) {return val = '';}))}}
