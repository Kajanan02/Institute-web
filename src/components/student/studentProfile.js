...
function StudentProfile() {
    ...
    const [studentAccordionOpen, setStudentAccordionOpen] = useState(true);
    const [parentAccordionOpen, setParentAccordionOpen] = useState(false);

    const toggleStudentAccordion = () => {
        setStudentAccordionOpen(!studentAccordionOpen);
    };

    const toggleParentAccordion = () => {
        setParentAccordionOpen(!parentAccordionOpen);
    };

    return (
        <Layout>
            <div className="container text-left pt-5">
                <div className={`accordion-section ${studentAccordionOpen ? 'open' : ''}`}>
                    <div className="accordion-header" onClick={toggleStudentAccordion}>
                        {/* View Students Details */}
                        <h4 className={"content-heading"}>View Students Details</h4>
                        <span className="dropdown-icon">
                            <FeatherIcon icon={studentAccordionOpen ? "chevron-up" : "chevron-up"} />
                        </span>
                    </div>
                    {studentAccordionOpen && (
                                ...
                                <div className={"pop-up-form-container"}>
                                    <div className={"row label-align mt-3"}>
                                        ...
                                        <div className={"col-6"}>
                                            <div className="mb-3">
                                                <label htmlFor="exampleInputEmail1"
                                                    className="form-label profile-view-text">Contact No:&nbsp;</label>
                                                <label htmlFor="exampleInputEmail1"
                                        ...
                                        <div className={"col-6"}>
                                            <div className="mb-3">
                                                <label htmlFor="exampleInputEmail1"
                                                    className="form-label profile-view-text">Date of Birth:&nbsp;</label>
                                                <label htmlFor="exampleInputEmail1"
            ...
            <div className="container text-left pt-3">
                <div className={`accordion-section ${parentAccordionOpen ? 'open' : ''}`}>
                    <div className="accordion-header" onClick={toggleParentAccordion}>
                        {/* View Parents Details */}
                        <h4 className={"content-heading"}>View Parents Details</h4>
                        <span className="dropdown-icon">
                            <FeatherIcon icon={parentAccordionOpen ? "chevron-up" : "chevron-up"} />
                        </span>
                    </div>
                    {parentAccordionOpen && (
                                ...
                                <div className={"pop-up-form-container"}>
                                    <div className={"row label-align mt-3"}>
                                        ...
                                        <div className={"col-6"}>
                                            <div className="mb-3">
                                                <label htmlFor="exampleInputEmail1"
                                                    className="form-label profile-view-text">Relationship to Student:&nbsp;</label>
