                    ...
                    <div className="card card-5 settings_card">
                        ...
                        <div className="settings_card-body">
                            <form method="POST">
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="value">
                                        <div className="input-group-desc">
                                            <input className="input--style-5 settings_input " type="text"
                                                   name="first_name"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button type="sumbit" className="btn btn-success btn-rounded settings_btn">Update
                                    Profile
                                </button>
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="value">
                                        <div className="settings_input-group_1">
                                            <input className="input--style-5 settings_input" type="password"
